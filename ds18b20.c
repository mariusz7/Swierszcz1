...
// Editor Tabs	: 4
//
// 20-Jun-2005 Mariusz Kedzierawski 1 added: avr-gcc support, minor fixes
//*****************************************************************************
...
//-----------------------------------------------------------------------------
uint8_t ds18b20Setup(dallas_rom_id_T* rom_id, uint8_t resolution,
    int8_t alarm_low, int8_t alarm_high)
{
	uint8_t error;
...
//	resolution = ((resolution - 9) << 5) | 0x60; //FIXED wczesnie bylo to, ale to niezgodne z doc
